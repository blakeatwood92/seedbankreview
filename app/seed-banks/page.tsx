...
export default function SeedBanksPage() {
  const seedBanks = [
    ...
    },
    {
      ...
      reviews: 312,
      location: "Canada",
      description: "Canadian seed bank specializing in single seed purchases starting at $1. Features premium breeders like Ethos, FastBuds, and Mephisto with fast domestic shipping.",
      paymentMethods: ["Interac E-Transfer", "Crypto", "Cash"],
      deliveryTime: "2-5 business days",
      shippingCost: "Varies",
      specialties: ["Single Seed Sales", "Premium Breeders", "Canadian Domestic", "$1 Seeds Available"],
      strainCount: "500+",
      affiliate: false,
