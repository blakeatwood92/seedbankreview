...
const internationalBanks = [
  {
    ...
    description: "Premium international seed bank from Spain with clever stealth packaging (seeds in garden gloves). Fast 7 business day shipping to Canada with delivery guarantee.",
    paymentMethods: ["Credit Card", "Apple Pay", "Google Pay", "PayPal", "Interac", "Bitcoin", "USDT"],
    shippingTime: "7 business days",
    shippingCost: "€10 (~$15 CAD)",
    customsSuccess: "98%",
    specialties: ["Stealth Packaging", "Delivery Guarantee", "Free Seeds with Orders", "7-Day Shipping"],
    pros: ["Fast 7 business day shipping from Spain", "Clever stealth packaging (seeds in garden gloves)", "Delivery guarantee - free reship if lost", "Accepts Interac for Canadians"],
    cons: ["Currency in EUR", "€10 shipping fee"],
