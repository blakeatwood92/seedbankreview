...
export default function CanadaPage() {
  const canadianBanks = [
    ...
    },
    {
      ...
      pros: ["Beginner friendly", "Outdoor genetics", "Northern climate strains", "Autoflowering options"],
      cons: ["Higher free shipping threshold", "Smaller selection"],
    ...
    },
    {
      ...
      pros: ["Competitive prices", "Bulk orders", "Prairie genetics", "Student discounts"],
      cons: ["Limited premium strains", "Fewer payment options"],
