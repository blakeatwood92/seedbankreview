...
const seedBankData: Record<string, {
    ...
    communityReviews: [
      {
        ...
        rating: 5,
        date: "2018-09-15",
        title: "Very good Canadian website",
        content: "Very good Canadian website and very well designed. The best designed I have seen. You can buy seeds there from the best seed banks in the world and using multiple filters to target a better search. Good photos and good reviews. The descriptions are quite comprehensive. The quantity of products is impressive. I have ordered several times and I am always satisfied!",
        helpful: 42,
        verified: true,
      },
      {
        ...
        rating: 5,
        date: "2020-03-15",
        title: "Great stealth shipping and freebies",
        content: "Placed my order and selected a stealth shipping item per their suggestion; I chose a Canuk Seeds black hoodie. Got confirmation email with order# and followed their simple instructions to send an interac e-transfer. Received my seeds 2-3 weeks later. My seeds were exactly as described, plus they included three free seed items. They threw in Desconocida Kush FEM, Sweet Tooth Auto, and 2 Hash Plant REG seeds. Seeds sprouted in less than 48 hours in paper towel. No complaints!",
        helpful: 38,
        verified: true,
      },
      {
        ...
        rating: 1,
        date: "2021-12-01",
        title: "Package sent to wrong state",
        content: "Was a yearly buyer from this company until they sent my package to a different state and claim that they can not do anything about my order since I did not purchase insurance. 200 dollars down the drain. I feel like the insurance thing is a scam as I never had to purchase insurance before. They are slow too. Never again.",
        helpful: 67,
        verified: true,
      },
      {
        ...
        rating: 4,
        date: "2020-03-10",
        title: "Used without issue",
        content: "Used True North Seedbank without an issue. If I had to choose one it would be JOTI or Peak, but True North has a good selection of trusted genetics and they are a pleasure to deal with.",
        helpful: 24,
        verified: true,
      },
      {
        ...
        rating: 2,
        date: "2020-06-01",
        title: "Poor germ rates on free seeds",
        content: "Free seeds had poor germ rates. Huge variation on 6 seeds of GG#4. Would not reorder seeds from True North Seed Bank. The purchased seeds were okay but nothing special for the price.",
        helpful: 31,
        verified: true,
      },
    ],
  ...
  "jordan-of-the-islands": {
    ...
    flag: "🇨🇦",
    established: "1992",
    description: "Historic Canadian breeder known for developing God Bud. Recent reports of customer service issues and germination problems.",
    longDescription: "Jordan of the Islands (JOTI) is a historic Canadian cannabis breeder based in British Columbia, operating since 1992. They developed the famous 'God Bud' strain and have had a following for their unique island-bred genetics. However, recent reports from Facebook users indicate significant issues with communication - some customers report zero contact from the owner after payment, and orders not being received. Our own test with Pink Kush resulted in a 0/5 germination rate. While their legacy genetics are notable, we cannot recommend them at this time until these issues are resolved.",
    ...
    pros: [
      ...
      "Direct from breeder - authentic genetics",
      "Strains adapted for Canadian climates",
      "Accepts cryptocurrency payments",
    ],
    cons: [
      "Recent reports of zero contact from owner after payment",
      "Facebook users report accepted money but seeds never received",
      "Poor germination rates - our Pink Kush test was 0/5",
      "Communication issues with customer service",
      "$15 flat rate shipping on all orders",
      "Website is basic and outdated",
    ],
    criteriaRatings: {
      paymentMethods: 4.0,
      seedVariety: 4.0,
      genetics: 3.0,
      customerExperience: 2.0,
      reputation: 3.0,
    },
    accentColor: "green",
    communityReviews: [
      {
        ...
        rating: 5,
        date: "2023-10-01",
        title: "Blue God - amazing fragrance",
        content: "One big Blue God was harvested on the 20th. Smallest was taken yesterday, Sept 30th - 1.2 lbs wet weight. An amazing fragrance surrounds these plants. Definitely the first Indica that I have grown. A very easy grow to maintain, and a very thirsty plant through all stages.",
        helpful: 89,
        verified: true,
      },
      {
        ...
        rating: 5,
        date: "2022-08-15",
        title: "Black Candyland - resinous and sticky",
        content: "Very resinous plants, perfect for pressing if that's what you're into. 'Dabs' that is a hard hitter. Did I mention how resinous and glue-like sticky them bud sugar leaves are? Great taste! Fruity and skunky packed with resin. Clone did well despite their odd shapes and the stress they were put through.",
        helpful: 56,
        verified: true,
      },
      {
        ...
        rating: 5,
        date: "2020-03-08",
        title: "Jordan of the Islands - A+",
        content: "Jordan of the Islands (JOTI) and Peak Seeds are my top recommendations. JOTI has excellent genetics and the customer service is top notch. If your seeds don't arrive, they reship without question.",
        helpful: 34,
        verified: true,
      },
      {
        ...
        content: "Just got my beans, and yup, total summer sale! 2 for 1 (regular 12 beans becomes 24+ of the same variety) I ordered Blueberry, my pack came with 25 beans AND 1 pack of breeder's choice (12 beans) I got White Berry OG. That's 36+ beans for 60CDN + 5CDN shipping in Canada. Super happy!",
        helpful: 56,
        verified: true,
      },
      {
        ...
        rating: 4,
        date: "2021-06-20",
        title: "Black Cali Grapes - good daytime herb",
        content: "This is a good daytime herb. It's similar to a good sativa high. I was expecting an indica stone and at first I wasn't happy with the result. I thought it was weak stuff. After another vape or 2 by the end of the evening I was so high. Easy to grow with strong resistance.",
        helpful: 28,
        verified: true,
      },
    ],
    ...
    communityReviews: [
      {
        ...
        rating: 5,
        date: "2024-02-15",
        title: "Grape Skunk - exceptional quality",
        content: "QCS Grape Skunk turned out amazing. The genetics are solid and true to description. Easy to grow and the yield was impressive. Quebec Cannabis Seeds has definitely earned my repeat business. Their customer support was helpful when I had questions about nutrients.",
        helpful: 73,
        verified: true,
      },
      {
        ...
        content: "I purchased 30 regular seeds from Quebec Cannabis Seeds - 6 different strains of 5 seed packs. They sent 52 seeds and 5 seeds of their Cinderella 99 (C99) - they say the extra seeds are to compensate for the males. I planted 30 and 25 germinated. Shipping was 5 days. They also added a discount code for 30% off my next order!",
        helpful: 65,
        verified: true,
      },
      {
        id: 3,
        author: "AutoGrower2024",
        source: "GrowDiaries",
        location: "Quebec",
        rating: 5,
        date: "2024-01-10",
        title: "Auto Bruce Banner - bestseller for a reason",
        content: "Ran their Auto Bruce Banner which is one of their bestsellers. 127g/plant average which is great for an auto. Easy grow, strong resistance to stress. The high is potent and the smell during flower was incredible. Will be ordering more QCS autos.",
        helpful: 48,
        verified: true,
      },
      {
        id: 4,
        author: "FruityPebbleFan",
        source: "GrowDiaries",
        location: "Ontario",
        rating: 4,
        date: "2023-09-20",
        title: "Fruity Pebble OG - great terps",
        content: "Grew their Fruity Pebble OG which has an 8.4 rating on GrowDiaries. Got about 46g/plant. The terp profile lived up to the name - fruity and sweet. Only minor issue was one seed took longer to germinate but they all made it eventually.",
        helpful: 31,
        verified: true,
      },
      {
        ...
        rating: 4,
        date: "2015-11-26",
        title: "International shipping took time but arrived safe",
        content: "Shipping internationally took about 5 months but it arrived finally. They did send it out immediately as they said, just the postal connection took that long. Thanks for the freebies, it's all discreet and safe placed, nothing broken. Seeds are germinating now.",
        helpful: 24,
        verified: true,
      },
    ],
