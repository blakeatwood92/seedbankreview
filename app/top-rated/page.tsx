...
const topRatedBanks = [
  ...
  },
  {
    ...
    customerService: 4.5,
    valueScore: 4.9,
    description: "Established Canadian seed bank in their 7th year. Single seeds from $1, authorized Ethos vendor.",
    highlights: [
      "7 years in business",
      "Single seeds from $1",
      "Authorized Ethos Genetics vendor",
      "Accepts PayPal and E-Transfer",
    ],
