  ...
  const internationalBanks = [
    {
      ...
      specialties: ["Stealth Packaging", "Delivery Guarantee", "Free Seeds", "7-Day Shipping"],
      description: "International seed bank from Spain with clever stealth packaging and fast 7 business day shipping to Canada.",
