    ...
    },
{
  name: "Quebec Cannabis Seeds",
      ...
      description: "Quebec-based seed bank built for Canadian hobbyists with easy-to-grow genetics suited for northern climates. Regular shipping 3-7 days, express shipping 1-2 days.",
      paymentMethods: ["Credit Card", "Interac E-Transfer"],
      shippingTime: "3-7 days (Express: 1-2 days)",
    ...
    },
    {
      name: "Gasd Up Seeds",
      slug: "gasd-up-seeds",
      logo: "/images/gasd-up-seeds-logo.png",
      rating: 4.4,
      reviews: 87,
